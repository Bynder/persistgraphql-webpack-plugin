...
describe("persistgraphql-webpack-plugin", function() {
  ...
  it("should extract queries from js and graphql files", function(done) {
    ...
    var compiler = webpack({
      ...
      resolveLoader: {
        alias: {
          "graphql-loader": path.resolve(
            path.join(__dirname, "../graphql-loader.js")
          ),
  ...
  it("should add typename to queries from js and graphql files", function(
    done
  ) {
    var virtualPlugin = new VirtualPlugin({
      "entry.js":
  ...
  it("should receive hashed queries from provider plugin if configured", function(
    done
  ) {
    var virtualProviderPlugin = new VirtualPlugin({
      "entry.js":
  ...
  it("should receive sha256 hashed queries from provider plugin if configured", function(
    done
  ) {
    var virtualProviderPlugin = new VirtualPlugin({
      "entry.js":
